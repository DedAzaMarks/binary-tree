...
class AbstractVisitor {
 public:
  ...
  virtual void print(NumberNode &number_node) = 0;
  virtual void print(MinusNode &minus_node) = 0;
  virtual void print(AddNode &add_node) = 0;
  virtual void print(SubNode &sub_node) = 0;
  virtual void print(MulNode &mul_node) = 0;
  virtual void print(DivNode &div_node) = 0;
};
